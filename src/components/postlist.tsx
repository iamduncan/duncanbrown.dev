...
export default function PostList({
  ...
  const imageProps = post?.coverImage ? urlForImage(post.coverImage) : null;
      ...
      >
        ...
        >
          ...
          >
            {imageProps ? (
              <Image
                src={imageProps.src}
                {...(post.coverImage.blurDataURL && {
                  placeholder: 'blur',
                  blurDataURL: post.coverImage.blurDataURL,
                })}
                alt={post.coverImage.alt || 'Thumbnail'}
        ...
        <div className={cx(minimal && 'flex items-center')}>
          <div>
            ...
            >
              <Link href={`/blog/${pathPrefix ? `${pathPrefix}/` : ''}${post.slug}`}>
                <span
      ...
      dark:from-purple-800 dark:to-purple-900"
            ...
            <div className="mt-3 flex items-center space-x-3 text-gray-500 dark:text-gray-400">
              <div className="flex items-center gap-3">
                ...
                <span className="truncate text-sm">Duncan Brown</span>
              </div>
