  ...
  return (
    <Container>
      ...
      <div className="text-center">
        <p className="text-lg">Want to get in touch?</p>
      </div>

      <div className="my-10 grid md:grid-cols-2">
        <div className="my-10">
          <h2 className="text-2xl font-semibold dark:text-white">Contact Duncan</h2>
          <p className="mt-5 max-w-sm">
            Have something to say? Fill up the form or send email.
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="my-10">
            ...
            <div className="mb-3">
              ...
              {errors.message && (
                <div className="mt-1 text-red-600">
                  {' '}
                  <small>{errors.message.message as ReactNode}</small>
                </div>
              )}
            </div>
